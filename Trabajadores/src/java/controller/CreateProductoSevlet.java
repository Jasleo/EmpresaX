...
@WebServlet(name = "CreateProductoSevlet", urlPatterns = {"/createProducto.do"})
public class CreateProductoSevlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                Logger.getLogger(CreateProductoSevlet.class.getName()).log(Level.SEVERE, null, ex);
